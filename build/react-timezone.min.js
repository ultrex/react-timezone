!function(e,a){"object"==typeof exports&&"object"==typeof module?module.exports=a(require("react")):"function"==typeof define&&define.amd?define(["react"],a):"object"==typeof exports?exports.ReactTimezone=a(require("react")):e.ReactTimezone=a(e.React)}(this,function(e){return function(e){function a(t){if(i[t])return i[t].exports;var r=i[t]={exports:{},id:t,loaded:!1};return e[t].call(r.exports,r,r.exports,a),r.loaded=!0,r.exports}var i={};return a.m=e,a.c=i,a.p="",a(0)}([function(e,a,i){"use strict";function t(e){return e&&e.__esModule?e:{"default":e}}function r(e,a){if(!(e instanceof a))throw new TypeError("Cannot call a class as a function")}function n(e,a){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!a||"object"!=typeof a&&"function"!=typeof a?e:a}function o(e,a){if("function"!=typeof a&&null!==a)throw new TypeError("Super expression must either be null or a function, not "+typeof a);e.prototype=Object.create(a&&a.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),a&&(Object.setPrototypeOf?Object.setPrototypeOf(e,a):e.__proto__=a)}var s=function(){function e(e,a){for(var i=0;i<a.length;i++){var t=a[i];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(a,i,t){return i&&e(a.prototype,i),t&&e(a,t),a}}();Object.defineProperty(a,"__esModule",{value:!0}),i(6);var c=i(7),u=(t(c),i(1)),l=t(u),M=i(4),T=t(M),f=function(e){function a(e){r(this,a);var i=n(this,Object.getPrototypeOf(a).call(this,e));return i.timezones=Object.keys(T["default"]),i.state={open:!1,timezones:i.timezones,focused:0,value:i.getTimezone(e.defaultValue||e.value)},i}return o(a,e),s(a,[{key:"componentWillReceiveProps",value:function(e){if(e.value!==this.props.value){var a=this.getTimezone(e.value);this.refs.field.value=a||"",this.setState({value:a})}}},{key:"render",value:function(){var e=this,a=this.state.value,i=!this.state.open&&a,t=this.state.open;return React.createElement("div",{className:(0,l["default"])("timezone-picker",{"timezone-picker-open":t,"timezone-picker-selected":i},this.props.className),style:this.props.style},React.createElement("div",{className:"timezone-picker-textfield"},React.createElement("input",{type:"text",placeholder:this.props.placeholder,onFocus:this.handleFocus.bind(this),onBlur:this.handleBlur.bind(this),onChange:this.handleFilterChange.bind(this),onKeyDown:this.handleKeyPress.bind(this),defaultValue:a,ref:"field"})),React.createElement("ul",{className:"timezone-picker-list",ref:"options"},this.state.timezones.map(function(a,i){var t=e.state.focused===i+1;return React.createElement("li",{key:i,title:a,onMouseDown:e.handleSelect.bind(e,i),className:(0,l["default"])("timezone-picker-list-item",{"timezone-picker-list-item-active":t})},a)})))}},{key:"getTimezone",value:function(e){return e?this.timezones.find(function(a){return e===T["default"][a]||e===a}):null}},{key:"filterItems",value:function(e){return""===!e.trim()?function(){return!0}:function(a){return a.toLowerCase().includes(e.toLowerCase().replace(/\s/g,""))}}},{key:"handleFocus",value:function(){this.refs.field.value="",this.setState({open:!0})}},{key:"handleBlur",value:function(){this.refs.field.value=this.state.value||"",this.setState({open:!1})}},{key:"handleFilterChange",value:function(){var e=this.refs.field.value.trim();this.setState({timezones:this.timezones.filter(this.filterItems(e)),focused:0})}},{key:"handleKeyPress",value:function(e){if(38===e.which||40===e.which){e.preventDefault();var a=this.state.focused;38===e.which?(a-=1,1>a&&(a=this.state.timezones.length)):(a+=1,a>this.state.timezones.length&&(a=1)),this.setState({focused:a}),this.refs.options.children[a-1].scrollIntoView()}else 0!==this.state.focused&&(13===e.which?(this.handleSelect(this.state.focused-1),e.target.blur()):this.setState({focused:0}))}},{key:"handleSelect",value:function(e){this.setState({timezones:this.timezones,focused:0,open:!1}),this.props.onChange?this.props.onChange(T["default"][this.state.timezones[e]]):(this.refs.field.value=this.state.timezones[e],this.setState({value:this.state.timezones[e]}))}},{key:"value",value:function(){var e=this.state.value;return e?T["default"][e]:null}}]),a}(React.Component);a["default"]=f},function(e,a,i){var t,r;/*!
